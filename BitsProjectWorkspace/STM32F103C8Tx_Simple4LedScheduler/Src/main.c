/**
  ...
  * @date Feb 13, 2022
  * @author Kunal Verma
  * @details This file contains function definitions and
  ...
  *                               * SysTick Timer count clock = 8 Mhz
  *                               * 1ms = 1Khz
  *                               * Reload value = 8Mhz/1Khz = 8000
 ******************************************************************************
 */
...
/**
 * @brief idle task comes into picture when there is no user task running in the system
 */
void idle_task(void)
{
	while(1);
...
// task handler contain the code to be executed in loop.
...
//while initializing systick timer,
//counter is loaded to a tick value and systick is enabled
